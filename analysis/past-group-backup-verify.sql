select jsonb_pretty(jsonb_build_object(
 'bookings_table',to_regclass('private_migration_backups.past_group_bookings_20260913_0930')::text,
 'accounts_table',to_regclass('private_migration_backups.past_group_accounts_20260913_0930')::text,
 'activity_table',to_regclass('private_migration_backups.past_group_activity_20260913_0930')::text,
 'rpc_table',to_regclass('private_migration_backups.past_group_rpc_20260913_0930')::text,
 'manifest_table',to_regclass('private_migration_backups.past_group_manifest_20260913_0930')::text,
 'manifest',(select jsonb_agg(to_jsonb(m) order by kind) from private_migration_backups.past_group_manifest_20260913_0930 m),
 'source_hashes',(
 ...
 'rpc_rows',(select count(*) from private_migration_backups.past_group_rpc_20260913_0930),
 ...
 'rls',(select jsonb_agg(jsonb_build_object('table',c.relname,'enabled',c.relrowsecurity) order by c.relname) from pg_class c join pg_namespace n on n.oid=c.relnamespace where n.nspname='private_migration_backups' and c.relname like 'past_group_%_20260913_0930')
)) backup_verification;
