-- Restore Parent Calendar cancellation against the database clock after the
-- My Classes surface became permanently read-only. All cancellation transitions
-- still require the explicit parent-calendar or club workflow.
